    ...
    return (
        <Card ref={setNodeRef} style={style} {...listeners} {...attributes}>
            <Card.Meta
                ...
                description={
                <>
                    <div style={{inlineSize: '50px', whiteSpace:'pre-wrap', color: '#0091ae', fontWeight: '500', width:'100%'}} dangerouslySetInnerHTML={{__html:DOMPurify.sanitize(props.item.descricao)}}></div>
